    ...
    <body>
        ...
        <%
            ...
            if (request.getParameter("accion") != null) {
                try {
                    ...
                    while (rs1.next()) {
                        ...
                        ruta = request.getContextPath() + "/imagen/imagen/" + imagen;
                        bandera = true;
                    }
                } catch (Exception e) {
                    nombre = "ERROR";
            ...
            if (request.getParameter("actualizar") != null) {
                ...
                String query = "UPDATE Alumno SET nombre = ?, edad = ?, estatura = ?, imagen = ? WHERE idAlumno = ?";
                ...
                ps2.setString(4, imagen);
                ps2.setInt(5, Integer.parseInt(idAlumno));
                ps2.executeUpdate();
            }
        %>
        ...
        <form action=''>
            ...
            <input type="text" name="imagen" value="<%=imagen%>" placeholder="IMAGEN"/>
